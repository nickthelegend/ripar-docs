...
| --- | --- | --- |
| Identity | `768570170` | Agent id → domain → controlling address |
| Reputation | `768570171` | Payments credited, USDC volume, validator verdicts |
| Validation | `768570174` | The job board and its verdicts |
