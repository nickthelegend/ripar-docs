...
| --- | --- | --- |
| Identity | `768572968` | Agent id → domain → controlling address |
| Reputation | `768572969` | Payments credited, USDC volume, validator verdicts |
| Validation | `768572979` | The job board and its verdicts |
